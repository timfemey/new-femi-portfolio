...
import { CloseIcon, HamburgerMenuIcon, ProjectIcon } from './nav-icons';
import siteConfig from 'site.config';
import { EmailIcon, FileIcon } from './social-icons';
...
const items: NavItemData[] = [
  ...
  { label: 'Resume', href: siteConfig.profiles.resume, icon: FileIcon },
  { label: 'Email', href: siteConfig.profiles.email, icon: EmailIcon },
];
